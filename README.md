...
Copyright © 2024–2026 jyjy0623. All rights reserved.

本项目采用 **Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International（CC BY-NC-SA 4.0）** 授权。

### 你可以

- ✅ 分享（转载、传播本项目的副本）
- ✅ 改编（修改、转换、基于本项目创作衍生作品）

### 条件

- **署名（BY）**：必须注明原作者，提供本许可证链接，说明是否做出修改
- **非商业（NC）**：不得将本项目或衍生作品用于商业目的，包括但不限于出售、收费分发、商业产品集成
- **相同方式共享（SA）**：若基于本项目进行再创作，必须使用相同许可证发布

### 禁止

- ❌ 商业使用（包括直接销售、打包收费、集成到付费产品）
- ❌ 去除版权声明后再发布
- ❌ 以不兼容许可证发布衍生作品

完整授权条款：[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh)
