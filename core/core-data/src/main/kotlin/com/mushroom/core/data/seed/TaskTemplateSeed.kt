    ...
    suspend fun seed() {
        val builtIn = listOf(
            ...
            TaskTemplateEntity(
                ...
                defaultDeadlineOffset = 15 * 60,  // 当天15:00
                baseRewardLevel = "SMALL",
                baseRewardAmount = 1,
            ...
            TaskTemplateEntity(
                ...
                defaultDeadlineOffset = 17 * 60,  // 当天17:00（放学前）
                baseRewardLevel = "SMALL",
                baseRewardAmount = 2,
                bonusRewardLevel = "MEDIUM",
                bonusRewardAmount = 1,
                bonusConditionType = "WITHIN_MINUTES",
                bonusConditionValue = 180,         // 距开始30分钟内完成（提前完成）
                isBuiltIn = true
            )
        )
        builtIn.forEach { templateDao.insert(it) }  // OnConflictStrategy.REPLACE 确保最新内置数据
    }
}
